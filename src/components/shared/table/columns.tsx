...
import { mapDoughType } from '../../../shared/constants/shaurma';
// import {
//   DropdownMenu,
//   DropdownMenuContent,
//   DropdownMenuItem,
                ...
                <div className='' key={index}>
                  <Collapsible>
                    ...
                    <CollapsibleContent>
                      ...
                      <span>
                        <b> цена за ед:</b> {item?.productVariant?.price} р.,
                        <br />
                        ...
                        {item?.ingredients.length ? (
                          <div>
                            <b> доп. ингредиенты:</b>{' '}
                            {Object.values(item?.ingredients).map(
                              (ingredient, i) => (
                                <span key={i}>
